...
from lab3.db import get_session
...
from lab3.services.books import (
    create_book_service,
    delete_book_service,
...
@router.get(
    ...
    summary="Отримати список книг (cursor-пагінація)",
)
async def get_books(
    ...
    cursor: Optional[str] = Query(
        default=None,
        description="Курсор для пагінації. Отримується з поля `next_cursor` попередньої відповіді.",
    ),
